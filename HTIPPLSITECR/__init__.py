...
def download_azure():
    DEST_FILE='ip_cr_pollolandia_model.sav'
...
def NEX_MAIN(lat, lon):
    ...
    categories = ['CAJERO', 'COFFEE SHOP', 'OTROS SIN CLASIFICACION',
       'RESTAURANTE POPULAR', 'IGLESIA', 'COLEGIO', 'VENTA DE CARNES',
       'PARQUE', 'CENTRO COMERCIAL', 'OTROS RESTAURANTE', 'CADENA QSR',
       'CADENA QSR POPULAR', 'AGROPECUARIA', 'BARBERÍA/BELLEZA',
       'FERRETERIA', 'PANADERIA', 'HELADERIA', 'REPUESTOS VEHICULOS',
       'BANCO', 'CLINICA DE SALUD', 'OFICINAS GUBERNAMENTALES',
       'ESTACION POLICIAL', 'TORTILLERIA', 'FARMACIA', 'PARADA DE BUS',
       'TIENDA DE BARRIO', 'HOTEL', 'GASOLINERA', 'MERCADO CANTONAL',
       'LIBRERIA', 'AGENCIA TELEFONIA', 'ALMACEN', 'UNIVERSIDAD',
       'PARQUEO', 'HOSPITAL', 'SUPERMERCADO', 'TIENDA MOTOCICLETAS',
       'ALMACEN DE ELECTRODOMESTICOS']
    ...
    cp = close_points('COSTA RICA', 'POLLOLANDIA', lat, lon)
